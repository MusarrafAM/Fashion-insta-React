...
const JoinUs = () => {
  return (
    <div className="w-full bg-[#FFF4F1]">
      <div className="py-10 max-w-[1240px] mx-auto text-center">
        <h1 className="md:text-5xl text-4xl font-bold mb-5">Join Us</h1>
        <p className="md:text-xl text-lg max-w-[80%] mx-auto">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestiae
          quisquam eaque officia natus expedita ullam, sit porro similique
          repellat.
        </p>
          ...
          <div className="each-item my-20">
            ...
            <div>
              ...
              <p className="mb-4">
                ...
                enim praesentium blanditiis eligendi, quibusdam cumque
                aspernatur porro, consequuntur cum harum a, officia ratione
                culpa laborum maxime sapiente eveniet temporibus repellendus!
              </p>
